...
THREE.OculusRiftEffect = function ( renderer, options ) {
	...
	var renderScale = (options && options.renderScale) ? options.renderScale : 1.0;
	...
	this.setHMD = function(v) {
		...
		renderTarget = new THREE.WebGLRenderTarget( HMD.hResolution*distScale/2 * renderScale, HMD.vResolution*distScale * renderScale, RTParams );
	...
	this.render = function ( scene, camera, vstate ) {
